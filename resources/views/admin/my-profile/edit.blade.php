<x-admin-layout :breadcrumbs="$breadcrumbs" :title="$title">
    <x-slot name="script">
        <script>
            $(function() {
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                <div class="align-items-center d-flex justify-content-center m-4">
                    <label class="d-inline-block me-2">Updating your account...</label>
                    <div class="spinner-border spinner-border-sm" role="status">
                        <label class="visually-hidden">Updating your account...</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body p-4">
            ...
            <form id="post_form" action="{{ route('admin.my-profile.update', $user->id) }}" method="POST">
                @csrf
                @method('put')
